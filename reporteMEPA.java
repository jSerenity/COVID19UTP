...
public class reporteMEPA extends JPanel {
    ...
    public JPanel mandos(){
        ...
        titulo = new JLabel("Reporte de Pacientes"); 
    ...
    public void onchange(ChangeEvent e){
        ...
        if(e.getSource()== edad){
            System.out.println("esad");
            dataPaciente.listar(dtm_paciente, "edad");
        }
    }
    ...
    public void reporte(String orden)
    {
        ...
        {      
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport("R_pacientes.jasper",parametro,db.getCon());        
